...
## Method
Our current array contains efficiency of the for $e_1, e_2,...e_{n-1}$. To compute $e_n$, let us blow up a fixed $e$. $e_1 = a_1 - a_2 + a_1 - a_3 .... a_1 - a_n$, which can be rearranged into th form $e_1 = (n - 1) \cdot a_1 - a_2 - a_3 ... - a_n$. Now, summing up all the efficiency once they've been rearranged in this way gives us: $[\sum_{k=1}^{n - 1} e_k] = a_1 + a_2 ... a_{n - 1} - (n - 1) \cdot a_n$, so if we multiply this by -1, we get precisely the efficiently $e_n$.